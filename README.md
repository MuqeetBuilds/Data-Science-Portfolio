...
Welcome to my master repository! My name is Muqeet, and here you will find all my end-to-end Data Science projects spanning Regression, Classification, and Unsupervised Learning.

### 📂 Table of Contents:

#### 1. [✈️ Flight Price Prediction (Regression)](./01_Flight_Price_Regression) 
* **Goal:** Predicting real-time flight ticket prices.
* **Tech:** Random Forest Regressor, One-Hot Encoding.
